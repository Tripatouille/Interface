...
EditBoxDummy:SetWidth(TukuiDB.infowidth)
EditBoxDummy:SetHeight(TukuiDataBottom:GetHeight())
EditBoxDummy:SetPoint("BOTTOM", ChatFrame1, "TOP", 0, TukuiDB.Scale(6))
...
local function SetupChatPosAndFont(self)
	for i = 1, NUM_CHAT_WINDOWS do
		...
		if i == 1 then
			...
			_G["ChatFrame"..i]:SetSize(TukuiDB.Scale(TukuiDB.infowidth - 4), TukuiDB.Scale(TukuiCF["chat"].chatheight))
			FCF_SavePositionAndDimensions(chat)
		elseif i == 3 and name == "Perso" then
			chat:ClearAllPoints()
			chat:SetPoint("BOTTOMLEFT", ChatULBackground, "BOTTOMLEFT", TukuiDB.Scale(2), TukuiDB.Scale(4))
			_G["ChatFrame"..i]:SetSize(TukuiDB.Scale(TukuiDB.infowidth - 4), TukuiDB.Scale(TukuiCF["chat"].chatheight))
			FCF_SavePositionAndDimensions(chat)
	...
	BNToastFrame:HookScript("OnShow", function(self)
		self:ClearAllPoints()
		self:SetPoint("BOTTOMLEFT", ChatULBackground, "TOPLEFT", 0, TukuiDB.Scale(3))
	end)
end
