if TukuiDB.client == "frFR" then
	...
	tukuilocal.chat_invalidtarget = "Cible incorrecte"
	...
	tukuilocal.core_welcome1 = "Bienvenue sur |cffC495DDSpike's Edit de Tukui|r, version "
	tukuilocal.core_welcome2 = "Tapez |cff00FFFF/uihelp|r pour plus d'info, tapez |cff00FFFF/tukui|r pour configurer, ou visitez http://www.tukui.org/v2/forums/topic.php?id=1235"
	...
	tukuilocal.bind_combat = "Vous ne pouvez pas définir de raccourcis en combat."
	...
	tukuilocal.bind_instruct = "Survoler le bouton d'action avec votre souris pour le définir le raccourci. Appuyer sur Echap ou clic droit pour supprimer le raccourci actuel."
