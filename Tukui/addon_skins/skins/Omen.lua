...
Mod_AddonSkins:RegisterSkin("Omen",function(Skin, skin, Layout, layout, config)
	...
	Omen.UpdateBackdrop = function(self)
		...
		self.BarList:SetPoint("TOPLEFT", self.Title, "BOTTOMLEFT",0,-1)
		self.BarList:SetBackdropColor(unpack(TukuiCF["media"].backdropfadecolor))
		self.Title:SetBackdropColor(unpack(TukuiCF["media"].backdropfadecolor))
--		self.Title:SetPoint("TOPLEFT", OmenDummyFrame, "TOPLEFT", 0, 0)
